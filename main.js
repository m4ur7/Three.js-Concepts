...
const sunflowerTexture = new THREE.TextureLoader().load('sunflower.jpg');
const sunflower = new THREE.Mesh(new THREE.BoxGeometry(3, 3, 3), new THREE.MeshBasicMaterial({ map: sunflowerTexture }));
scene.add(sunflower);
...
sunflower.position.z = -5;
sunflower.position.x = 2;
